...
import { TARGET_TYPES, getTargetTypeById } from './constants/targetTypes'
import './App.css'
          ...
          <>
            ...
            {selectedTargetType && !scanResults && (
              <div className="scanner-view">
                ...
                <h2>
                  {getTargetTypeById(selectedTargetType)?.icon}{' '}
                  {getTargetTypeById(selectedTargetType)?.name} Security Assessment
                </h2>
                <ScannerForm 
